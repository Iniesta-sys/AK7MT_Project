...
class MainActivityCurrencyEUR : AppCompatActivity()
{
    private lateinit var binding: ActivityMainCurrencyEurBinding

    override fun onCreate(savedInstanceState: Bundle?)
    {
        super.onCreate(savedInstanceState)
        binding = ActivityMainCurrencyEurBinding.inflate(layoutInflater)
